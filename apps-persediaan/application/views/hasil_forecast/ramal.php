        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Ramal Data Penjualan</h4>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active"><?= $nama_db?></li>
                        </ol>
                    </div>
                                ...
                                <div class="row">
                                    <div class="p-4 col-md=12">
                                        <blockquote class="blockquote">
                                            <p>Ramal Penjualan Barang di masa depan </p>
                                        </blockquote>
                                        ...
                                        <form action="<?= base_url('hasil/hitungramal') ?>" method="POST">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    aria-describedby="emailHelp" value="<?= $dt_databarang['id_databarang']?>"  hidden name="id_databarang">
                                                
                                            </div>
                                            <div class="form-group ">
                                                <label for="bulan">Ramal Penjualan Barang <?= $nama_db?></label>
